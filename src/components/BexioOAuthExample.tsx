...
export const BexioOAuthExample = () => {
  const fullScope = "openid profile email company_profile offline_access accounting contact_show contact_edit project_show project_edit monitoring_show monitoring_edit invoice_show invoice_edit kb_offer_show kb_invoice_show kb_credit_voucher_show kb_bill_show";
