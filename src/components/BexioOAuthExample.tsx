...
export const BexioOAuthExample = () => {
  ...
  const apiScopes = ["accounting", "contact_show", "contact_edit", "project_show", "project_edit", "timesheet_show", "timesheet_edit", "invoice_show", "invoice_edit", "kb_offer_show", "kb_invoice_show", "kb_credit_voucher_show", "kb_bill_show"];
